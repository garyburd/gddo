...
ADD https://github.com/golang/snappy/archive/eaa750b9bf4dcb7cb20454be850613b66cda3273.zip /x/snappy.zip
RUN unzip /x/redigo.zip -d /x && unzip /x/snappy.zip -d /x && \
	mkdir -p /go/src/github.com/garyburd && \
	mkdir -p /go/src/github.com/golang && \
	mv /x/redigo-* /go/src/github.com/garyburd/redigo && \
	mv /x/snappy-* /go/src/github.com/golang/snappy && \
	rm -rf /x
